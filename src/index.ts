...
// ipcMain.on("load-recipe", e => {
//   console.log("we load now", e);
...
//       if (err) {
//         return console.log("error when reading", err);
//       }
//       try {
//         const fileRead = JSON.parse(data);
//         console.log("file read success get dude neat", fileRead);
//         e.sender.send("load-success", fileRead);
//       } catch (err) {
